...
Algo.BACKGROUND_COLOR = "#EEFFEE";
Algo.PRINT_COLOR = Algo.FOREGROUND_COLOR;
...
Algo.FIRST_PRINT_POS_X  = 50;
Algo.PRINT_VERTICAL_GAP  = 20;
Algo.PRINT_HORIZONTAL_GAP = 50;
...
Algo.prototype.init = function(am, w, h)
{
    ...
    for(i = 0 ;i < max_vars ;i++){
        this.no_ofitems_invar.push(i*52);
        this.lists.push([]);
        this.dicts.push({});
    }
    ...
    this.Ins_num = 0;    
    this.Instructions = [];
    this.Instructions = get_instructions(this.Instructions);
}
